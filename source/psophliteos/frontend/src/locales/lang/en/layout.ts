export default {
  ...
  header: {
    ...
    inputRepeatNew: 'Please repeat new password',
    passwordFormatError: 'Password is invalid',
    diffNewPassword: 'Two passwords do not match',
    changePassSuccess: 'password change success, please login again',
