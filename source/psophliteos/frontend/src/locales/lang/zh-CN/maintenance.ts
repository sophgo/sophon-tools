export default {
  ...
  metricsForward: {
    title: 'Prometheus 指标转发',
    desc: '将 bmssm 的 Prometheus 指标经本页面端口(8080)转发，设备只暴露 8080 一个端口。默认关闭。',
    enable: '启用转发',
    token: '抓取 Token',
    tokenTip: 'Prometheus 抓取时作为 Bearer Token 使用；轮换后旧 Token 立即失效',
    rotate: '轮换 Token',
    rotateConfirm: '轮换后旧 Token 立即失效，需同步更新 Prometheus 配置。确认轮换？',
    promCfg: 'Prometheus 抓取配置示例',
    copy: '复制',
    copied: '已复制',
    monitor: '转发监控',
    bmssmReachable: 'bmssm 可达',
    reachable: '正常',
    unreachable: '不可达',
    scrapeOK: '累计成功抓取',
    scrapeErr401: '鉴权失败(401)',
    scrapeErr502: '上游错误(502)',
    lastScrapeAt: '最近抓取',
    lastError: '最近错误',
    sinceStart: '统计起点（自服务启动）',
    disabledHint: '转发已关闭：/metrics 返回 404，外部无法抓取',
    enabledHint: '转发已开启：携带 Token 抓取 http://<设备IP>:8080/metrics',
    enableOk: '转发已开启',
    disableOk: '转发已关闭',
    none: '无',
  },
