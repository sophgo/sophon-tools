...
export function useFormRules(formData?: Recordable) {
  ...
  const getNewPasswordFormRule = computed(() => createRule(t('layout.header.inputRepeatNew')));
    ...
    switch (unref(currentState)) {
      ...
      case LoginStateEnum.CHANGE_PASSWORD:
        return {
          ...
          repeatNewPassword: [
            ...newPasswordFormRule,
            { validator: validateConfirmNewPassword(formData?.newPassword), trigger: 'change' },
          ],
        };
      // mobile form rules
