                                ...
                                int sophon_idx, int pcie_no_copyback)
{
    ...
    av_dict_set(&dict, "rtsp_flags", "prefer_tcp", 1);
    av_dict_set(&dict, "probesize", "50000000", 0);
    av_dict_set(&dict, "analyzeduration","20000000", 0);
                                      ...
                                      int output_format_mode, int sophon_idx, int pcie_no_copyback)
{
    ...
    *dec_ctx = avcodec_alloc_context3(decoder);// have fix_fmt
    ...
    av_dict_set_int(&opts, "zero_copy",pcie_no_copyback, 1);
