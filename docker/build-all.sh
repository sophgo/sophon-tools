...
PLATFORMS[pdfss_cpp]="amd64/arm64/armbi/loongarch64/riscv64/sw_64/win-amd64/win-i686 + dfss pip 包"
...
if [[ "${LIST_ONLY:-0}" = "1" ]]; then
  echo "=== sophon-tools 16 子项目构建清单（pmulti_video_qt/phytool/spacc 已排除，单镜像 ${IMAGE}） ==="
