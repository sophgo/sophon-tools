...
| [sewriter](./source/psewriter) | source/psewriter | SE写卡工具（Windows 单文件）：把发版文件包/目录/整卡镜像写成 SE 系列设备 TF 卡，也可只格式化 TF 卡；写后回读校验。见 [使用说明](./source/psewriter/README.md) / [开发与构建](./source/psewriter/BUILD.md) |
